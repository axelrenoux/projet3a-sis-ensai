...
public class AlbumSearchHandler extends DefaultHandler{
	...
	throws SAXException{
		...
		if(inName){
			...
			//on veut ajouter l'artiste à l'album, 
			...
			if(Controleur.getInstanceuniquecontroleur().existeDeja(currentArtist)){
				...
				System.out.println("ùùùùùù 1"+ Controleur.getInstanceuniquecontroleur().
				...
				System.out.println("ùùùùùù 2"+ Controleur.getInstanceuniquecontroleur().
						getListeArtistes().get(currentArtist.getName()));
				currentAlbum.setArtiste(Controleur.getInstanceuniquecontroleur().
				getListeArtistes().get(currentArtist.getName()));//TODO
				
				System.out.println("ùùùùùù 3"+ currentAlbum.getArtiste());
			}
